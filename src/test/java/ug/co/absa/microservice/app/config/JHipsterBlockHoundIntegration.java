...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ug.co.absa.microservice.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ug.co.absa.microservice.app.security.DomainUserDetailsService", "createSpringSecurityUser");
