...
import ug.co.absa.microservice.app.GatewayServiceUgApp;
import ug.co.absa.microservice.app.config.AsyncSyncConfiguration;
import ug.co.absa.microservice.app.config.EmbeddedElasticsearch;
...
@SpringBootTest(classes = { GatewayServiceUgApp.class, AsyncSyncConfiguration.class, TestSecurityConfiguration.class })
