...
To build the final jar and optimize the GatewayServiceUG application for production, run:
...
Then navigate to [http://localhost:9580](http://localhost:9580) in your browser.
